		...
		<div class="row">
			<div class="email-edge col-lg-2">
				...
				<dl class="email-folder">
					<dt>文件夹</dt>
					<dd>
						<a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe639;</i>收件箱<button class="layui-btn  layui-btn-danger layui-btn-mini f-r">12</button></a>
					</dd>
					<dd>
						<a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe603;</i>发信</a>
					</dd>
					<dd>
						<a href="javascript:;" data-url="email-list.html"><i class="iconfont">&#xe602;</i>草稿<button class="layui-btn layui-btn-warm layui-btn-mini f-r">2</button></a>
					</dd>
					<dd>
