							...
							<tbody>
								...
								<tr id='node-2' class="child-node-1 parent collapsed" style="display:none ;" parentid="1">
									...
									<td>
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1" data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="2" data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="2" data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
										</div>
									</td>
								</tr>
								<tr id='node-3' class="child-node-2 parent collapsed" style="display: none;" parentid="1">
									...
									<td>
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1" data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="3" data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="3" data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
										</div>
									</td>
								</tr>
								<tr id='node-4' class="child-node-2 parent collapsed" style="display: none;" parentid="1">
									...
									<td>
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1" data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="4" data-url="menu-add.html"> <i class="layui-icon">&#xe642;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="4" data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
										</div>
									</td>
								</tr>
								<tr id='node-4' class="child-node-2 parent collapsed" style="display: none;" parentid="1">
								...
								<tr id='node-6' class="child-node-5 parent collapsed" style="display: none;" parentid="1">
									...
									<td>
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1" data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="6" data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="6" data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
										</div>
									</td>
								</tr>
								<tr id='node-7' class="child-node-5 parent collapsed" style="display: none;" parentid="1">
									...
									<td>
										<div class="layui-inline">
											<button class="layui-btn layui-btn-mini layui-btn-normal  add-btn" data-id="1" data-url="menu-add.html"><i class="layui-icon">&#xe654;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-normal  edit-btn" data-id="7" data-url="menu-add.html"><i class="layui-icon">&#xe642;</i></button>
											<button class="layui-btn layui-btn-mini layui-btn-danger del-btn" data-id="7" data-url="menu-add.html"><i class="layui-icon">&#xe640;</i></button>
										</div>
									</td>
								</tr>
							</tbody>
